    ...
    P: PredicateChecker<E::Fr, A, AV, AC, ACG>,
{
    ...
    ark_groth16::create_random_proof(monolith_prover, pk, rng)
}

pub fn verify_monolithic<E, A, AV, AC, ACG, H, HG, P>(
    pvk: &Groth16PreparedVerifyingKey<E>,
    roots: &ComForestRoots<E::Fr, H>,
    ...
    P: PredicateChecker<E::Fr, A, AV, AC, ACG>,
{
    ...
    //let prepared = ark_groth16::prepare_inputs(&pvk, &public_inputs).unwrap();
